...
const Services = () => {
  return (
    ...
    id='Services' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center mb-2 text-lg font-Ovo'>Explore the World of Technology</motion.h4>
      <motion.h2
       initial={{ opacity: 0, y: -20 }}
       whileInView={{ opacity: 1, y: 0 }}
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
         Welcome to my blog section! Here, I share my insights on web development, programming, and technology trends. Let’s learn and build together!</motion.p>
