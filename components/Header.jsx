...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      >
        <Image src={assets.profile1} alt='' className='rounded-full w-32'/>
      </motion.div>
        <motion.h3
        initial={{y: -20,opacity: 0}}
        whileInView={{y:0,opacity:1}}
        transition={{duration: 0.6, delay:0.3}}
        className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi! I'm Abhishek   <Image src={assets.hand_icon} alt='' className='w-6'/></motion.h3>
        ...
        I’m learning full stack web development and sharpening my problem-solving skills through Data Structures and Algorithms in Java.
        </motion.p>
