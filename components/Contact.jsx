...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "9662e1b1-76c3-49f3-8db9-76268c998793");
  ...
  return (
    <motion.div
      ...
      <motion.h4
        ...
        className='text-center mb-2 text-lg font-Ovo'>Connect and Collaborate</motion.h4>
      <motion.h2
        initial={{ opacity: 0, y: -20 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      <motion.p
        ...
        Whether you're a fellow tech enthusiast, collaborator, or just someone passionate about coding, I’d love to hear from you!</motion.p>
