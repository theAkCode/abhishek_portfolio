    ...
    return (
        <motion.div
            ...
            className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
                Discover the projects I’ve worked on, ranging from creative web designs to complex web applications. Each one represents a step forward in my journey as a developer.</motion.p>
